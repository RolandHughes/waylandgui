...
*/
/**
 * \file waylandgui/button.h
 *
 * \brief Defines the [Normal/Toggle/Radio/Popup] \ref waylandgui::Button widget.
 */

#pragma once

#include <waylandgui/widget.h>

NAMESPACE_BEGIN(waylandgui)
/**
 * \class Button button.h waylandgui/button.h
 *
 * \brief [Normal/Toggle/Radio/Popup] Button widget.
 */
class WAYLANDGUI_EXPORT Button : public Widget {
public:
     ...
     *
     * \param parent
     *     The \ref waylandgui::Widget this Button will be attached to.
     *
     * \param caption
     *     The name of the button (default ``"Untitled"``).
     *
     * \param icon
     *     The icon to display with this Button.  See \ref waylandgui::Button::mIcon.
     */
    ...
    /// Returns the icon of this Button.  See \ref waylandgui::Button::m_icon.
    int icon() const { return m_icon; }
    /// Sets the icon of this Button.  See \ref waylandgui::Button::m_icon.
    void set_icon(int icon) { m_icon = icon; }

    /// The current flags of this Button (see \ref waylandgui::Button::Flags for options).
    int flags() const { return m_flags; }
    /// Sets the flags of this Button (see \ref waylandgui::Button::Flags for options).
...
protected:
     ...
     * :ref:`file_waylandgui_entypo.h`.  The kind of icon (image or Entypo)
     * is determined by the functions :func:`waylandgui::nvgIsImageIcon` and its
     * reciprocal counterpart :func:`waylandgui::nvgIsFontIcon`.
     * \endrst
     */
    int m_icon;

...
/**
 * \class CheckBox checkbox.h waylandgui/checkbox.h
 *
 * \brief Two-state check box widget.
 *
 * \remark
 *     This class overrides \ref waylandgui::Widget::mIconExtraScale to be ``1.2f``,
 *     which affects all subclasses of this Widget.  Subclasses must explicitly
 *     set a different value if needed (e.g., in their constructor).
 */
class WAYLANDGUI_EXPORT CheckBox : public Widget {
public:
    /**
     ...
     *     \ref waylandgui::CheckBox::mPushed for the difference between "pushed"
     *     and "checked".
     */
   ...
   const std::string &caption() const { return m_caption; }
    ...
    /// Whether or not this CheckBox is currently pushed.  See \ref waylandgui::CheckBox::m_pushed.
...
protected:
     ...
     * \ref waylandgui::CheckBox::m_callback is only called upon release.  See
     * \ref waylandgui::CheckBox::mouse_button_event for specific conditions.
     */
    bool m_pushed;
    ...
    /// The function to execute when \ref waylandgui::CheckBox::m_checked is changed.

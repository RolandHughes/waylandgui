/*
    waylandgui/widget.h -- Base class of all widgets
...
/**
 * \class Widget widget.h waylandgui/widget.h
 *
 * \brief Base class of all widgets.
 *
 * \ref Widget is the base class of all widgets in \c waylandgui. It can
 * also be used as an panel to arrange an arbitrary number of child
 * widgets using a layout generator (see \ref Layout).
 */
class WAYLANDGUI_EXPORT Widget : public Object {
public:
     ...
     * See \ref waylandgui::Widget::m_icon_extra_scale.
     */
...
protected:
     ...
     *
     * \remark
     *     See also: \ref waylandgui::Theme::m_icon_scale and
     *     \ref waylandgui::Widget::m_icon_extra_scale.  This tiered scaling
...
protected:
     ...
     *        that \ref waylandgui::Widget::icon_scale simply returns the value
     *        of \ref waylandgui::Theme::m_icon_scale.
     *
     * Most widgets do not need extra scaling, but some (e.g., CheckBox, TextBox)
     * need to adjust the Theme's default icon scaling
     * (\ref waylandgui::Theme::m_icon_scale) to properly display icons within their
     ...
     *    the :func:`waylandgui::Widget::icon_scale` function.  Expected usage when

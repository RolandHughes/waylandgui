/*
    waylandgui/textbox.h -- Fancy text box with builtin regular
...
/**
 * \class TextBox textbox.h waylandgui/textbox.h
 *
 * \brief Fancy text box with builtin regular expression-based validation.
 *
 * \remark
 *     This class overrides \ref waylandgui::Widget::mIconExtraScale to be ``0.8f``,
 *     which affects all subclasses of this Widget.  Subclasses must explicitly
 *     set a different value if needed (e.g., in their constructor).
 */
class WAYLANDGUI_EXPORT TextBox : public Widget {
public:
...
/**
 * \class IntBox textbox.h waylandgui/textbox.h
 *
...
/**
 * \class FloatBox textbox.h waylandgui/textbox.h
 *

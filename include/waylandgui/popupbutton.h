/*
    waylandgui/popupbutton.h -- Button which launches a popup widget
...
/**
 * \class PopupButton popupbutton.h waylandgui/popupbutton.h
 *
 ...
 */
class WAYLANDGUI_EXPORT PopupButton : public Button {
public:

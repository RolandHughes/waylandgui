/*
    waylandgui/messagedialog.h -- Simple "OK" or "Yes/No"-style modal dialogs
...
/**
 * \class MessageDialog messagedialog.h waylandgui/messagedialog.h
 *
 * \brief Simple "OK" or "Yes/No"-style modal dialogs.
 */
class WAYLANDGUI_EXPORT MessageDialog : public Window {
public:

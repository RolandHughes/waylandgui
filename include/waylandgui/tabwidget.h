/*
    waylandgui/tabwidget.h -- Widget for organizing multiple
...
/**
 * \class TabWidgetBase tabwidget.h waylandgui/tabwidget.h
 *
 ...
 */
class WAYLANDGUI_EXPORT TabWidgetBase : public Widget {
public:
...
/**
 * \class TabWidget tabwidget.h waylandgui/tabwidget.h
 *
 ...
 *    .. code-block:: cpp
 *
 *       // `this` might be say a waylandgui::Screen instance
 ...
 *    .. code-block:: cpp
 *
 *       // `this` might e.g. be a waylandgui::Screen instance
 *       Window *window = new Window(this, "Window Title");
 *       TabWidget *tab_widget = window->add<TabWidget>();
 *       // Create a tab first
 ...
 *    in :ref:`waylandgui_example_1` (search for ``tab_widget`` in the file).
 *
 * \endrst
 */
class WAYLANDGUI_EXPORT TabWidget : public TabWidgetBase {
public:
    /// Construct a new tab widget

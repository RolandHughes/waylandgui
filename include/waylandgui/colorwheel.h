...
/**
 * \class ColorWheel colorwheel.h waylandgui/colorwheel.h
 *
 * \brief Fancy analog widget to select a color value.  This widget was
 *        contributed by Dmitriy Morozov.
 */
class WAYLANDGUI_EXPORT ColorWheel : public Widget {
public:
    /**
...
protected:
     ...
     * waylandgui::ColorWheel::color for its usage.  Valid values are in the range
     * ``[0, 1]``.
     */
    float m_white;
     ...
     * \ref waylandgui::ColorWheel::color for its usage.  Valid values are in the
     * range ``[0, 1]``.
     */
    float m_black;

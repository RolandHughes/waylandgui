...
/**
 * \file waylandgui/renderpass.h
 *
 * \brief Defines abstractions for rendering passes that work with 
 * GLFW3 Wayland
 */
...
class WAYLANDGUI_EXPORT RenderPass : public Object {
public:
    /// Depth test

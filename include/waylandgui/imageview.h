/*
    waylandgui/imageview.h -- Widget used to display images.
...
/**
 * \class ImageView imageview.h waylandgui/imageview.h
 *
 ...
 */
class WAYLANDGUI_EXPORT ImageView : public Canvas {
public:
...
protected:
    waylandgui::ref<Shader> m_image_shader;
    waylandgui::ref<Texture> m_image;
    float m_scale = 0;
    Vector2f m_offset = 0;

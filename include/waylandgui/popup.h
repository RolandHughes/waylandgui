/*
    waylandgui/popup.h -- Simple popup widget which is attached to another given
...
/**
 * \class Popup popup.h waylandgui/popup.h
 *
 ...
 */
class WAYLANDGUI_EXPORT Popup : public Window {
public:

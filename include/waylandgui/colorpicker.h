...
#include <waylandgui/popupbutton.h>

NAMESPACE_BEGIN(waylandgui)

/**
 * \class ColorPicker colorpicker.h waylandgui/colorpicker.h
 *
 * \brief Push button with a popup to tweak a color value.
 */
class WAYLANDGUI_EXPORT ColorPicker : public PopupButton {
public:
    /**
     ...
     * before the user clicks \ref waylandgui::ColorPicker::mPickButton or
     * \ref waylandgui::ColorPicker::mPickButton.
     */
     ...
     * **and** the user clicks the \ref waylandgui::ColorPicker::m_pick_button or
     * \ref waylandgui::ColorPicker::m_reset_button.
     */
    ...
    /// The current caption of the \ref waylandgui::ColorPicker::m_pick_button.
    const std::string &pick_button_caption() { return m_pick_button->caption(); }

    /// Sets the current caption of the \ref waylandgui::ColorPicker::m_pick_button.
    void set_pick_button_caption(const std::string &caption) { m_pick_button->set_caption(caption); }

    /// The current caption of the \ref waylandgui::ColorPicker::m_reset_button.
    const std::string &reset_button_caption() { return m_reset_button->caption(); }

    /// Sets the current caption of the \ref waylandgui::ColorPicker::m_reset_button.
...
protected:
     ...
     * \ref waylandgui::ColorPicker::set_pick_button_caption if you need.
     *
     * The color of this Button will not affect \ref waylandgui::ColorPicker::color
     * until the user has actively selected by clicking this pick button.
     * Similarly, the \ref waylandgui::ColorPicker::m_callback function is only
     ...
     * \ref waylandgui::ColorPicker::m_pick_button.  The default value for the
     * caption of this Button is ``"Reset"``.  You can change it using
     * \ref waylandgui::ColorPicker::set_reset_button_caption if you need.
     */

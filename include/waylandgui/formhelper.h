...
#include <waylandgui/label.h>
#include <waylandgui/checkbox.h>
#include <waylandgui/textbox.h>
#include <waylandgui/combobox.h>
#include <waylandgui/colorpicker.h>
...
/**
 * \class FormWidget formhelper.h waylandgui/formhelper.h
 *
 ...
 *
 * - Inheritance from :class:`waylandgui::ComboBox` for ``enum`` types:
 *
 *   .. code-block:: cpp
 *
 *      template <typename T>
 ...
 *
 * - Inheritance from :class:`waylandgui::IntBox` for integral types:
 *
 *   .. code-block:: cpp
 *
 *      template <typename T>
 ...
 *
 * - Inheritance from :class:`waylandgui::FloatBox` for floating point types:
 *
 *   .. code-block:: cpp
 *
 *      template <typename T>
 ...
 *
 * - Inheritance from :class:`waylandgui::CheckBox` for booleans:
 *
 *   .. code-block:: cpp
 *
 *      template <>
 ...
 *
 * - Inheritance from :class:`waylandgui::TextBox` for strings:
 *
 *   .. code-block:: cpp
 *
 *      template <>
 ...
 *
 * - Inheritance from :class:`waylandgui::ColorPicker` for :class:`waylandgui::Color` types:
 *
 *   .. code-block:: cpp
 *
 *      template <>
 ...
 *
 * Please refer to the bottom of :ref:`program_listing_file_waylandgui_formhelper.h`
...
/**
 * \class FormHelper formhelper.h waylandgui/formhelper.h
 *
...
protected:
    /// A reference to the \ref waylandgui::Screen this FormHelper is assisting.
    ref<Screen> m_screen;
    /// A reference to the \ref waylandgui::Window this FormHelper is controlling.
    ref<Window> m_window;
    /// A reference to the \ref waylandgui::AdvancedGridLayout this FormHelper is using.
...
public:
    ...
    /// Pass-through function for \ref waylandgui::CheckBox::set_checked.
    void set_value(bool v) { set_checked(v); }

    /// Pass-through function for \ref waylandgui::Widget::set-enabled.
    void set_editable(bool e) { set_enabled(e); }

    /// Returns the value of \ref waylandgui::CheckBox::checked.
...
public:
    ...
    /// Pass-through function for \ref waylandgui::ComboBox::selected_index.
    T value() const { return (T) selected_index(); }

    /// Pass-through function for \ref waylandgui::ComboBox::set_selected_index.
    void set_value(T value) { set_selected_index((int) value); m_selected_index = (int) value; }

    /// Pass-through function for \ref waylandgui::ComboBox::set_callback.
    void set_callback(const std::function<void(const T &)> &cb) {
        ComboBox::set_callback([cb](int v) { cb((T) v); });
    }

    /// Pass-through function for \ref waylandgui::Widget::set_enabled.
    void set_editable(bool e) { set_enabled(e); }
};
...
public:
    ...
    /// Pass-through function for \ref waylandgui::TextBox::set_callback.
...
public:
    ...
    /// Pass-through function for \ref waylandgui::ColorPicker::set_color.
    void set_value(const Color &c) { set_color(c); }

    /// Pass-through function for \ref waylandgui::Widget::set_enabled.
    void set_editable(bool e) { set_enabled(e); }

    /// Returns the value of \ref waylandgui::ColorPicker::color.

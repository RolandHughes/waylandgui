/*
    waylandgui/vscrollpanel.h -- Adds a vertical scrollbar around a widget
...
/**
 * \class VScrollPanel vscrollpanel.h waylandgui/vscrollpanel.h
 *
 * \brief Adds a vertical scrollbar around a widget that is too big to fit into
 *        a certain area.
 */
class WAYLANDGUI_EXPORT VScrollPanel : public Widget {
public:
